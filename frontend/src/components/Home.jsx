...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="h-screen md:h-[1050px] text-white container mx-auto">
        {/* Header */}
        <header className="flex items-center justify-between p-6 ">
          <div className="flex items-center space-x-2">
            ...
            />
            <h1 className="md:text-2xl text-orange-500 font-bold">Coursera</h1>
          </div>
        ...
        <section className="text-center py-20">
          <h1 className="text-4xl font-semibold text-orange-500">Coursera</h1>
          ...
          <div className="space-x-4 mt-8">
            ...
            <Link
              to={"https://www.youtube.com/user/coursera/videos"}
                ...
                <div className="relative flex-shrink-0 w-92 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <Link
                        to={`/buy/${course._id}`}
                        className="mt-4 block bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300"
                      >
                        Enroll Now
                      </Link>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-2xl text-orange-500 font-bold">Coursera</h1>
              </div>
